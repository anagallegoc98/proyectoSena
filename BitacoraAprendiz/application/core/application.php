...
class Application
{
    ...
    public function isRequiredLogin()
    {
     ...
     $login = array("login/", "login/index", "login/recuperarcontrasena", "login/recover");

        // Aca van los metodos a los que puedo acceder sin login, tienen que ir en MINUSCULA TODO
     $controllers = array("login/", "login/index", "login/validar","login/listar_roles", "error/index", "error/", "login/recuperarcontrasena", "login/recover");
     ...
     if (! in_array($access, $controllers)) 
     {
        ...
        // Si va al login, se verifica que este logueado y si es así pasa al home
...
if(in_array($access, $login))
{
    ...
    //         if($_SESSION["idRol"]==1){
    //             header("location: ".URL."aprendiz/index");
    //         }
    ...
    // }
        ...
        // if (isset( $_SESSION["isLogin"])) 
        // {  
        //     $datos=$_SESSION["idRol"];
        //     if($datos==1)
        //     {
        //         if (in_array($access, $loginAprendiz)) 
        //         {
        //             if(! in_array($access,$login2))
        //             {
        //                 header("location: ".URL."aprendiz/index");
        //             }
        //         }
