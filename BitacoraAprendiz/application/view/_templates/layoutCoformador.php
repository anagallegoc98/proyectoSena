...
<head>
  ...
  <script src="<?php echo URL;?>js/bootstrap.min.js"> </script>
   ...
   <script src="<?php echo URL;?>js/alertify.js"> </script>
   <script src="<?php echo URL;?>js/alertify.min.js"> </script>
   <script src="<?php echo URL;?>js/alertify.css"> </script>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-top" role="navigation">
     <div class="navbar-header">
      ...
      <h1> <a class="navbar-brand" href="<?php echo URL;?>coformador/verAprendices">Bitacoras</a></h1>         
    </div>
      ...
      <div class="navbar-default sidebar" role="navigation">
        ...
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="<?php echo URL;?>coformador/verAprendices" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Aprendices</span> </a>
            </li>


            <li>
               <a href="<?php echo URL;?>coformador/perfilCoformador" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Perfil</span> </a>
            </li>
