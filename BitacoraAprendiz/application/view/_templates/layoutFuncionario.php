  ...
  <div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-top" role="navigation">
     <div class="navbar-header">
      ...
      <h1> <a class="navbar-brand" href="index.html">Bitacoras</a></h1>         
    </div>
    <div class=" border-bottom">
      ...
      <div class="drop-men" >
        <ul class=" nav_1">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span class=" name-caret">Funcionario<i class="caret"></i></span><img src="<?php echo URL; ?>img/wo.jpg"></a>
      ...
      <div class="navbar-default sidebar" role="navigation">
        ...
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="<?php echo URL;?>funcionario/verProgramas" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Mis Aprendices</span> </a>
            </li>

           
            <li>
              <a href="<?php echo URL;?>funcionario/perfilFuncionario" class=" hvr-bounce-to-right"><i class="fa fa-dashboard nav_icon "></i><span class="nav-label">Perfil</span> </a>
            </li>
