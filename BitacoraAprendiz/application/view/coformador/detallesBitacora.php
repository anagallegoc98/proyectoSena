	...
	<div class="subapartado">
		...
		<div class="informacion">
			<p class="informacion"><div >
				...
				<?php if( $bitacora->aprobada == 1 ) { ?> <a>- Bitacora Aprobada</a>
				<?php } else { ?>  <a>- Bitacora No Aprobada</a> <?php } ?>
...
<div class="observaciones" id="observaciones">
	...
	<table class="table table-inverse">
		...
		<table class="table">
			<tdody>
			<tr><td colspan="3"><center><h3>Nueva Observacion:</h3></td></center></tr>
				<tr>



					<td><textarea  id="txtObservaciones" name="txtObservaciones" style="margin: 0px; width: 880px; height: 104px;">
					</textarea></td>
	...
	<br><br>
	<button id="btnGuardarObservacion" name="btnGuardarObservacion" class="btn btn-primary" type="button">Guardar observacion</button>
	<button id="btnAprobarBitacora" name="btnAprobarBitacora" class="btn btn-success" type="button">Aprobar Bitácora</button>
	<button id="btnVolver" name="btnVolver" class="btn btn-danger" type="button">Volver</button>
